...
//		
//		boolean b1 =p1.test(new Student("khushi",25,500,"female"));
//		
...
//		st.add(new Student("khushi",25,500,"female"));
...
//			
//		};
//		c.accept(new Student("khushi",25,500,"female"));
//		
//		List<Student> st = new  ArrayList<>();
//		st.add(new Student("khushi",25,500,"female"));
//		st.add(new Student("yash",29,450,"male"));
...
//		Supplier<Student> s = () -> {
//			return new Student("khushi",25,500,"female");
//			
//			
//			
//			
...
//		
		...
		Employee emp =f.apply(new Student("khushi",25,500,"female"));
